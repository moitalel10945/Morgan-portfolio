<nav x-data="{ open: false }"   class="bg-surface-light shadow-sm border-b border-gray-200">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-16 items-center">
        ...
        <a href="/" class="text-xl font-bold text-gray-800"><?php echo e(config('app.name')); ?></a>
...
</nav><?php /**PATH C:\Users\Administrator\Desktop\portfolio\resources\views/components/navbar.blade.php ENDPATH**/ ?>