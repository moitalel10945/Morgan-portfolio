...
<div class="max-w-5xl mx-auto px-6 py-24 text-center flex flex-col-reverse md:flex-row  justify-between items-center gap-16">
    ...
    <h1 class="text-4xl md:text-6xl font-bold tracking-tight text-gray-900"><?php echo e($title); ?></h1>
    <p class="text-lg  mt-6 text-gray-600 max-w-2xl mx-auto"><?php echo e($subtitle); ?></p>
    <div class="mt-10 flex justify-center  md:justify-start gap-4">
        <a href="/projects" class="btn-primary">View my work</a>
    </div>
    </div>
    <div>
        <img src="<?php echo e(asset('images/me.jpg')); ?>" class="border-4 border-white shadow-2xl object-cover rounded-2xl relative w-72 md:w-96 lg:w-[420px] ">
...
</section><?php /**PATH C:\Users\Administrator\Desktop\portfolio\storage\framework/views/livewire/views/e36e8bf1.blade.php ENDPATH**/ ?>